...
def get_grlc_history(start,end,fname):
    '''
    ...
    url = 'https://coinmarketcap.com/currencies/garlicoin/historical-data/?start={0}&end={1}'.format(str(start),str(end))
    ...
    with open(fname,'wb') as f:
        ...
        for row in rows:
            writer.writerow(row)
    return df
get_grlc_history(20180127,20180306,'test.csv')
